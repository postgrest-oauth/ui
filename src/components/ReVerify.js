...
if ( currentLocation.pathname.length > 11 ) {
  usernameValue = currentLocation.pathname.slice(11);
}

export default class ReVerify extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  submitForm = () => {
    ...
    fetch(`${process.env.REACT_APP_OAUTH_URL}/re-verify`, options)
      .then((response)=> {
